...
export function LoginForm({
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    form.setValue(e.target.name as "email" | "password", e.target.value, {
      shouldValidate: true,
      shouldTouch: true,
    });
  };
                          ...
                          <Bento className="w-full">
                            <div className="main-box-1 h-full flex items-center justify-between relative border border-[#E3E2E2] px-4 py-3 gap-1 sm:gap-2">
                              <div className="flex items-center gap-2 sm:gap-4 flex-1 w-full">
                                ...
                                <div className="h-4 border-r border-black/10" />
                                <input
                                  className="rounded-none border-0 placeholder:text-black/40 bg-transparent outline-none cursor-text text-sm sm:text-base"
                                  type="password"
                                  placeholder="********"
                                  required
                                  name="password"
